...
//	}
	...
	public String getMedicineJson() throws SQLException {
		ArrayList<Medicine> medicineList = hms.getMedicineList();

		return g.toJson(medicineList);


	}

	public String getMedicinetypeJson(String mtype) throws SQLException {
		ArrayList<Medicine> medicineList = hms.getMedicinetypeList(mtype);
	...
	/*
	 * public ArrayList<Room> getRooms(){ return hms.getRoomList(); } /* public
	 * ArrayList<doctornote> getDoctors(){
	 * 
	 * return hms.getDoctorList(); } public ArrayList<Patient> getPatients(){
	 * return hms.getPatientList(); } public ArrayList<Nurse> getNurses(){
	 * return hms.getNurseList(); }
	 * 
	 * public ArrayList<Indoor> getIndoors(){ return hms.getIndoorList(); }
	 * 
	 * 
	 * 
	 * 
	 * 
	 * 
	 * public String getNurseJson(int nid) throws SQLException{ Nurse nurse;
	 * 
	 ...
	 * 
	 * public String getPrescriptionsJson(int prid) throws SQLException{ return
	 * hms.getPrescription(prid).toJson(); }
	 * 
	 * 
	 * 
	 ...
	 * return g.toJson(presList); }
	 * 
	 * public void addPres(Prescription p, int uid) throws SQLException{ int did
	 * = hms.getDidByUid(uid);
	 * 
	 * p.setDid(did);
	 * 
	 ...
	 * hms.addIndoor(indo); }
	 * 
	 * public void updatePatient(int pid, int uid, String type) throws
	 * SQLException{ Patient p = hms.getPatient(pid);
	 * p.setDid(hms.getDidByUid(uid)); p.setType(type); hms.updatePatient(p); }
	 * 
	 * 
	 * 
	 ...
	 * 
	 * 
	 * public String addPatient(Patient patient) throws SQLException { return
	 * hms.addPatient(patient).toJson(); }
	 */
}
