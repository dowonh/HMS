...
//						request.getRequestDispatcher("index.jsp").forward(request, response);
	...
	public void updateNurse(HttpServletRequest request, HttpServletResponse response)
	...
	// }
	//
	// public void deletePatient(HttpServletRequest request, HttpServletResponse
	// response) throws IOException, SQLException{
	//
